...
migration_path = os.path.join(os.path.dirname(__file__), "supabase", "worker_approval_status_migration.sql")
...
if success:
    print("\nSuccessfully applied worker approval status migration!")
else:
    print("\n" + "=" * 60)
    ...
    print(f"  Copy contents from: supabase/worker_approval_status_migration.sql")
    print("=" * 60)
