...
migration_path = os.path.join(os.path.dirname(__file__), "supabase", "no_show_protection_migration.sql")
...
if not success:
    ...
    print(f"  Copy contents from: supabase/no_show_protection_migration.sql")
    print("=" * 60)
else:
    print("\nNo-Show Protection Migration applied successfully!")
